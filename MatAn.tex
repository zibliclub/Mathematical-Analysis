...
\begin{proof}
  ...
  \begin{lemma}
    ...
    разбиению $P''$ и $p(m(P')) \leqslant p(m(P')) + 2(\omega_i(x(t)) + \omega_i(y(t)))$, где
  ...
  \begin{proof}
    ...
    $| M_{i-1}M' | + | M'M_i | \leqslant ???$

    $M_i = \gamma (t_i) = (x(t_i);y(t_i))$ {\Large РИСУНОК}

    $| M'M_i | \leqslant | x(t_i) - x(t') | + | g(t_i) - y(t') |$
  \end{proof}
\end{proof}
